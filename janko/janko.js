...
async function main(){
    ...
    '--disable-setuid-sandbox',
      ...
      await page.$eval('input[id=ulogin]', el => el.value = 'popoz123');
...
async function discord(){
    try{
        ...
        await page.screenshot({path: `ekwipunekdjanko.png`, fullPage: true});
        const well = bot.channels.get("683374637819756623")
        await well.send({files: [`./ekwipunekdjanko.png`]}).then(msg => (msg.delete(120000)));
        const path = `./ekwipunekdjanko.png`
